        ...
        switch(this.state.page) {
          ...
          return (
            ...
            <Navbar brand="HEALTHYMENTED" right style={{backgroundColor:'#4AB4CB'}}>
              <NavItem onClick={() => this.onNavBarClick('home')}>HOME</NavItem>
                <NavItem onClick={() => this.onNavBarClick('about')}>ABOUT</NavItem>
                  <NavItem onClick={() => this.onNavBarClick('reviews')}>REVIEWS</NavItem>
                    <NavItem onClick={() => this.onNavBarClick('contact us')}>CONTACT US</NavItem>
                      <NavItem onClick={() => this.onNavBarClick('partners')}>PARTNERS</NavItem>
