  ...
  render() {
    ...
    let contentChoice = () => {
      switch(this.state.page) {
        case 'mapfilter':
          return (
            <MapFilter healthField={this.state.healthField} onPropertyChange={this.setPropertyChange} markers={this.state.clinics} {...this.state}/>
          )
        case 'home':
        ...
        case 'map':
          return (
            ...
            <Map center = {
              location
            } markers={this.state.clinics}/> </div>
          )
      }
